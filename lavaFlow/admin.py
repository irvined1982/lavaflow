...
for i in [OpenLavaSubmitOption, OpenLavaTransferFileOption, JobStatus, Cluster, Project, Host, Queue, Job, OpenLavaTransferFile, OpenLavaResourceLimit, JobSubmitOpenLava, Task, Attempt, OpenLavaResourceUsage, OpenLavaExitInfo]:
